...
function Footer() {
    return ( 
        <div className='container'style={{backgroundColor:"#fbfbfb",marginLeft:"50px",marginRight:"50px"}}>
            <div className='row p-5'>
                <div className='col'>
                    <img src='media/logo.svg' style={{width:"60%", marginLeft:"20px"}}/>
                    <p style={{fontSize:"12px", marginTop:"20px"}}>© 2010 - 2026, Zerodha Broking Ltd.
